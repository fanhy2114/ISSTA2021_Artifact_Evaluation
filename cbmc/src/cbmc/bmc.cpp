...
/**
 * Set up some information about memory model and ubound size.
 */
void bmct::setup() {
    get_memory_model();
...
/**
 * do language unknown bounded model checking
 * @param opts command line options
 * @param goto_model the goto program
 * @param ui UI
 * @param message message stream?
 * @param frontend_configure_bmc
 * @return int
 */
